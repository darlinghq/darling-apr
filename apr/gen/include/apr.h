...
#if !defined(DARLING) || defined(__x86_64__)
...
#define APR_SIZEOF_VOIDP 4
 ...
 // the original generated code doesn't have this conditional, only the typedefs above by themselves
 // we need to add this to support 32-bit as well
